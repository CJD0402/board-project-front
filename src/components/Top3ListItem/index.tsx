...
export default function Top3ListItem({ item }: Props) {
  ...
  //         render         //
  return (
    <div className='top3-list-item-box' onClick={onClickHandler} style={background}>
      <div className="top3-list-item-container">
        <div className="top3-list-item-writer">
          <div className="top3-list-item-profile">
            <div className="top3-list-item-profile-image" style={{ backgroundImage: `url(${writerProfileImage ? writerProfileImage : defaultPrfileImage})` }}></div>
          </div>
