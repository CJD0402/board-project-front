...
import defaultPrfileImage from 'src/assets/default-profile-image.png'
  ...
  return (
    <div className='board-list-item-box' onClick={onClickHandler}>
      <div className="board-list-item-left">
        <div className="board-list-item-writer">
          <div className="board-list-item-profile">
            <div className="board-list-item-profile-image" style={{ backgroundImage: `url(${writerProfileImage ? writerProfileImage : defaultPrfileImage})` }}></div>
          </div>
      ...
      <div className="board-list-item-right">
        <div className="baord-list-item-board-image" style={{ backgroundImage: `url(${imageUrl})` }}></div>
      </div>
    </div>
  )
}
