...
export default function Main() {
  ...
  //         function         //
  // description: 페이지 이동을 위한 내비게이터 함수 //
  ...
  const MainTop= () => {
    ...
    //         effect         //
    // description: 첫 시작 시 인기게시물 데이터 불러오기 //
    useEffect(() => {
    ...
    return (
      <div className="main-top">
        <div className="main-top-text-container">
          <div className="main-top-text"><span className='board-name'>Dongs board</span>에서</div>
