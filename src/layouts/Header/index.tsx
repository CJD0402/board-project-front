...
export default function Header() {
  ...
  const { boardTitle, boardContent, boardImage, boardImageUrl, resetBoard } = useBoardWriteStore();
  ...
  return (
    <div id='header'>
      <div className="header-left" onClick={onLogoClickHandler}>
        ...
        <div className="header-left-logo-text">Dongs Board</div>
      </div>
      <div className="header-right">
        ...
        {
          !isAuth && ( isMyPage ? (<div className="white-button" onClick={onSignOutButtonClickHandler}>로그아웃</div>) :
