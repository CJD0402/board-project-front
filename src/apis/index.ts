...
import { DeleteBoardResponseDto, GetBoardResponseDto, GetCommentListResponseDto, GetCurrentResponseDto, GetFavoriteListResponseDto, GetSearchBoardResponseDto, GetTop3ResponseDto, PatchBoardResponseDto, PostBoardResponseDto, PostCommentResponseDto, PutFavoriteResponseDto } from 'src/interfaces/response/board';
...
const API_DOMAIN = 'http://3.34.144.53:4040/api/v1';
...
const UPLOAD_FILE = () => `http://3.34.144.53:4040/file/upload`;
...
export const putFavoriteRequest = async (boardNumber: number | string, token: any) => {
